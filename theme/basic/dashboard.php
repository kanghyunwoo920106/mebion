...
<div id="fullpage">
        ...
        <div class="mVisual_wrap">
            <div class="main_wrap container">
                ...
                <div class="mouse_scroll" data-aos="fade-right" data-aos-delay="300">
                    <img src="<?=G5_THEME_URL?>/img/dashboard/mouse2.png"></img>
                    <p>SCROLL DOWN</p>
                </div>
            </div>
        </div>
        ...
        <div class="mVisual_wrap">
            ...
            <div class="main_wrap container">
                <div class="title_wrap">
                    <h1 class="title" data-aos="fade-right" data-aos-delay="100"><span class="point_color">COMPANY</span></h1>
                    <h1 class="title font-weight-bold" data-aos="fade-right" data-aos-delay="200">연구와 새로운도전</h1>
                    <h1 class="title font-weight-light" data-aos="fade-right" data-aos-delay="300">새로운 혁신을 시작합니다.</h1>
                </div>
            ...
            <div class="main_wrap container">
                <div class="left_wrap">
                    <div class="list_wrap">
                        <div>
                            <div class="title_wrap">
                                <h1 class="title" data-aos="fade-right" data-aos-delay="100"><span class="point_color">AFFILIATED HOSPITAL</span></h1>
                                <h1 class="title font-weight-bold" data-aos="fade-right" data-aos-delay="200">제휴병원</h1>
                            </div>   
                        </div>
                        <ul class="city_list_wrap" data-aos="fade-right" data-aos-delay="300">
                            <li data-name="seoul" data-num="1">서울특별시</li>
                            <li data-name="busan" data-num="2">부산광역시</li>
                            <li data-name="daegu" data-num="3">대구광역시</li>
                            <li data-name="incheon" data-num="4">인천광역시</li>
                            <li data-name="gwangju" data-num="5">광주광역시</li>
                            <li data-name="daejeon" data-num="6">대전광역시</li>
                            <li data-name="ulsan" data-num="7">울산광역시</li>
                            <li data-name="gyeonggi" data-num="8">경기도</li>
                            <li data-name="gangwon" data-num="9">강원도</li>
                            <li data-name="northchungcheong" data-num="10">충청북도</li>
                            <li data-name="southchungcheong" data-num="11">충청남도</li>
                            <li data-name="northjeolla" data-num="12">전라북도</li>
                            <li data-name="southjeolla" data-num="13">전라남도</li>
                            <li data-name="northgyeongsang" data-num="14">경상북도</li>
                            <li data-name="southgyeongsang" data-num="15">경상남도</li>
                            <li data-name="jeju" data-num="16">제주특별자치도</li>
                            <li data-name="sejong" data-num="17">세종특별자치시</li>
                        </ul>
                    </div>
                </div>
                <div class="mid_wrap">
                    <!-- <div id="map" style="width:100%;height:100%;margin: 0 auto;"></div> -->
                    <div class="map_container" data-aos="fade-left" data-aos-delay="200">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 800" preserveAspectRatio="xMaxYMin meet" xmlns:amcharts="http://amcharts.com/ammap" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
                            <defs>
                                <linearGradient id="gradient">
                                    <stop offset="5%"  stop-color="white" />
                                    <stop offset="95%" stop-color="white" />
                                </linearGradient>
                                <linearGradient id="gradient_active">
                                    <stop offset="0%"  stop-color="rgb(16,174,184)" />
                                    <stop offset="50%"  stop-color="rgb(70,195,156)" />
                                    <stop offset="100%" stop-color="rgb(109,209,144)" />
                                </linearGradient>
                                <linearGradient id="ggg" x1="0%" y1="0%" x2="0%" y2="100%">
                                    <stop offset="0%" stop-color="#e2e6eb"></stop>
                                    <stop offset="0%" stop-color="#f2f6f9"></stop>
                                </linearGradient>
    ...
    <section class="section section5">
        <div class="mVisual_wrap">
            <div class="main_wrap container">
                <div class="title_wrap">
                    <h1 data-aos="fade-right" data-aos-delay="100">ADDRESS</h1>
                    <p data-aos="fade-right" data-aos-delay="200">서울특별시 강동구 올림픽로 660</p>
                    <p data-aos="fade-right" data-aos-delay="300">B106~108호 (천호동, 천호멜크루주상복합)</p>
                </div>
            </div>
            <footer>
                <div class="container">
                    <div>
                        <a href=""><img src="<?php echo G5_THEME_URL?>/img/dashboard/logo_white.png" alt="Logo" class="footer_logo"></a>
                    </div>
                    <div class="address_wrap">
                        <p class="address_text">서울특별시 강동구 올림픽로 660, B106~108호 (천호동, 천호엘크루주상복합)</p>
                        <p class="address_text">대표자명 : 박희진  |  법인등록번호 : 110111-7248671  |  사업자등록번호 : 278-87-01262</p>
                    </div>
                    <div>
                        <p class="copyright_text">Copyright ⓒ Mebion. All rights Reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="right_wrap">
                    ...
                    <div class="list_wrap" style="-ms-overflow-style: none;">
...
<script>
    $(function() {
                ...
                afterLoad: function(anchorLink, index) {
                    ...
                    $('.open_menu').off().on('click',function(e) {
                        ...
                        if($('.nav_bar_wrap').css('left') != '0px') {
                            ...
                            $('.nav_bar_wrap').css('z-index','10')
                            $('.nav_bar_wrap').stop().animate({
                                left: 0
                            },500)
                        } else {
                            $('.menu_back_drop').removeClass('show');
                            $('.nav_bar_wrap').removeClass('on');
                            $('.nav_bar_wrap').stop().animate({
                                left: -200
                            },500);
                        }

                        $('.menu_back_drop').off().on('click', function() {
                            $('.menu_back_drop').removeClass('show');
                            $('.nav_bar_wrap').removeClass('on');
                            $('.nav_bar_wrap').stop().animate({
                                left: -200
                    ...
                    // 페이지 이동 버튼
                    $('.page_move_btn').on('click',function() {
                        if(index == 1) {
        ...
        function map_init() {
            ...
            // section4 행정구역 리스트 슬라이드
            $('.city_list_wrap').not('.slick-initialized').slick({
                slide: 'li',
                slidesToShow: 7,
                arrows: true,
                speed: 1000,
            ...
            // 행정구역 리스트 arrow 숨김처리
            var now_data_num = $('.city_list_wrap').find('.slick-current').attr('data-num');
            arrow_display(now_data_num);

            // 모바일 시 마커 사이즈 고정
            if($(window).width() < 768) {
                $('.marker').attr('src','https://img.icons8.com/office/40/000000/place-marker--v1.png')
            }

            // 마커 사이즈 조정 및 리스트 초기화
            $(window).resize(function() {
                $('.city_list_wrap').slick('setPosition')

                var data_num = $('.city_list_wrap .slick-current').attr('data-num')

                if($(window).width() < 758) {
                    marker_check_mobile(data_num)
                } else {
                    marker_check(data_num)
                }
            });

            // 행정구역 클릭 시 이벤트
            $('.land').on('click',function() {
                if($(this).attr('fill') == "url(#gradient)") {

                    $(this).attr('fill','url(#gradient_active)');
                    $(this).siblings().attr('fill','url(#gradient)');
                    ...
                    move_select_city(data_num);
                    arrow_display(data_num);
                    get_hospital_list(data_num,get_title);
                } 
            });

            // 행정구역 리스트 클릭 시 이벤트
            $('.city_list_wrap li').on('click',function() {
                ...
                move_select_city(data_num);
                arrow_display(data_num);
                get_hospital_list(data_num,data_name);
            });

            // 행정구역 리스트 이전 버튼 클릭 시 이벤트
            $('.slick-prev').on('click',function(e) {
                $selected = $('.city_list_wrap').find('.slick-current').attr('data-name');
                $('.city_list_wrap li').not('.slick-current');
                ...
                var get_title = $('.city_list_wrap').find('.slick-current').attr('data-name');
                var data_num = $('.city_list_wrap').find('.slick-current').attr('data-num');
            ...
            // 행정구역 별 제휴병원 리스트 가져오는 함수 
            function get_hospital_list(data_num,get_title) {
                var data_num = data_num;
                var get_title = get_title;

                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: '<?=G5_THEME_URL?>/hospital_util.php',
                    data: {
                        division_num: data_num,
                        hs_name: get_title
                    },
                    success: function(data) {
                        $('.section4 .right_wrap .title_wrap p').remove();
                        $('.section4 .right_wrap .list_wrap ul').remove();
                        $('.modal-body .title_wrap p').remove();
                        $('.modal-body .list_wrap ul').remove();

                        var $target_title = $('.modal-body .title_wrap');
                        var $target_list = $('.modal-body .list_wrap');
                        var $target_title2 = $('.section4 .right_wrap .title_wrap');
                        var $target_list2 = $('.section4 .right_wrap .list_wrap');

                        var vHtml = "<ul>";
                        var hs_division_name = "";
                        
                        $.each(data,function(index,value) {
                            var hs_name = value.hs_name;
                            hs_division_name = value.hs_division_name;
                            vHtml += "<li class='aos-init aos-animate' data-aos='fade-left' data-aos-delay='200'>" + hs_name +"</li>";
                        })

                        vTitle = "<p>" + hs_division_name + " 제휴병원</p>";
                        vHtml += "</ul>";
                        
                        $target_title.append(vTitle);
                        $target_list.append(vHtml);
                        $target_title2.append(vTitle);
                        $target_list2.append(vHtml);
            ...
            // 행정구역 선택 시 해당 리스트로 이동 함수
            function move_select_city(data_num) {
                $('.city_list_wrap').slick('slickGoTo',data_num - 1);
            }

            // 행정구역 arrow 숨김처리 함수
            function arrow_display(now_data_num) {
                now_data_num = $('.city_list_wrap').find('.slick-current').attr('data-num');
                if(now_data_num == 1) {
            ...
            // 행정구역 마커 표시 함수(웹)
            function marker_check(data_num) {
                // 마커 위치 값
                var marker_arr = [[272,211],[564,421],[494,370],[275,172],[563,198],[422,259],[520,430],[295,251]
                                    ,[256,342],[360,290],[403,196],[493,232],[608,211],[430,386],[540,347],[775,162],[391,234]];

                for(var i = 0; i < 17; i++) {
                    if(data_num == i + 1) {
                        $('.marker').css('top',marker_arr[i][0]).css('left',marker_arr[i][1]);    
                    }
                }

                $('.marker').attr('src','https://img.icons8.com/office/50/000000/place-marker--v1.png')
            }

            // 행정구역 마커 표시 함수(모바일)
            function marker_check_mobile(data_num) {
                // 마커 위치 값
                var marker_arr = [[185,178],[386,321],[334,281],[190,147],[386,165],[297,205],[358,335],[193,200]
                                    ,[172,278],[251,226],[271,167],[343,185],[408,196],[287,298],[371,269],[529,148],[274,198]];
